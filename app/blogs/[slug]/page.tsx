...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-16 sm:py-20 lg:py-24">
      <JsonLd data={getArticleSchema({ title: post.title, description: post.excerpt || post.title, path: `/blogs/${post.slug}`, datePublished: post.publishedAt || undefined, dateModified: post.updatedAt || undefined, image: post.mainImageUrl })} />
