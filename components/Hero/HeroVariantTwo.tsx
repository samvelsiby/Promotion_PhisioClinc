    ...
    <section className="relative w-full overflow-hidden bg-white">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-12 pb-12 sm:px-6 sm:pt-16 lg:px-8 lg:pt-20 lg:pb-16">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <motion.a
            href="https://promotionphysiotherapy.ca"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/95 text-base leading-relaxed mb-4">
                We are open on Saturday and Sunday and every day of the week. We do accept last minute physio appointments.
              </p>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                  <span className="text-white/90 text-sm">Last-minute appointments available</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
